...
bool ChooseSmallUnitsLayer::init()
{
	...
	CCLabelBMFont* lb_title = CCLabelBMFont::create(" CHOOSE YOUR TROOP UNITS ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
	...
	CCLabelBMFont* lb_title2 = CCLabelBMFont::create(" FOR EACH COLOR ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
	...
	playerCaption_ = CCLabelBMFont::create(" PLAYER ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
