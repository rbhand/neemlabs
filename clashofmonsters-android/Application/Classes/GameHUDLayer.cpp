...
bool GameHUDLayer::init()
{
	...
	for (int i=0; i<2; ++i)
	{
		...
		players_[i].outTurnsLeft_ = CCLabelBMFont::create("3", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
		...
		players_[i].outTroopsLeft_ = CCLabelBMFont::create("25", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
...
//		addChild(players_[i].bgAvatar_);
		...
		players_[i].outTimeLeft_ = CCLabelBMFont::create("3", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
		...
		players_[i].outHealthLeft_ = CCLabelBMFont::create(createWithFormat(" %d ", 0).c_str(), cocos2d_utils::textureName("badaboom.fnt").c_str());
