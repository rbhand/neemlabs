...
bool GameOverScreen::init()
{
	...
	outPoints_ = CCLabelBMFont::create(createWithFormat("%d", 20000).c_str(), cocos2d_utils::textureName("badaboom_points.fnt").c_str());
	outPoints_->setAnchorPoint(CCPoint(0.5, 0.5));
	bg_->addChild(outPoints_);
	
	lbPoints_ = CCLabelBMFont::create(createWithFormat(" XP ", 0).c_str(), cocos2d_utils::textureName("badaboom_points.fnt").c_str());
	...
	lbEarned_ = CCLabelBMFont::create(" YOU EARNED ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
	...
	lbTitle_ = CCLabelBMFont::create(" WINNER NAME ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
	...
	outAccumulatedPoints_ = CCLabelBMFont::create(createWithFormat("%d", 20000).c_str(), cocos2d_utils::textureName("badaboom_points.fnt").c_str());
	outAccumulatedPoints_->setAnchorPoint(CCPoint(1, 0.5));
	outAccumulatedPoints_->setScale(0.7);
	bg_->addChild(outAccumulatedPoints_);
	
	lbAccumulatedPoints_ = CCLabelBMFont::create(" ACCUMULATED POINTS SO FAR! ",
		cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str(), ct(120), kCCTextAlignmentCenter);
	...
	lbLoginIntoFacebook_ = CCLabelBMFont::create(" YOUR EXPERIENCE POINTS ONLY ACCUMULATE IF YOU LOG IN TO FACEBOOK. PLEASE LOG INTO FACEBOOK. ",
		cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str(), ct(310), kCCTextAlignmentCenter);
	...
	lbShareToFacebook_ = CCLabelBMFont::create(" POST YOUR SCORE AND GET ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
	...
	lbUnlocked_ = CCLabelBMFont::create(" YOU HAVE UNLOCKED ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
	...
	lbUnlockedUnitName_ = CCLabelBMFont::create(" MEGA OCTOPUS NAPRIMER ", cocos2d_utils::textureName("Fonts/BadaBoom-22.fnt").c_str());
...
void GameOverScreen::didFacebookShare(bool published, const Error& error)
{
	if (!error.isOk())
	{
		CCMessageBox("Share Failed", error.description().c_str());
