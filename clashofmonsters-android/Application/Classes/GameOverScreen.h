...
namespace monsters
{
	...
	private:
		...
		CCMenu* menu_;
		CCLayer* bg_;
		CCLabelBMFont* lbTitle_;
		CCLabelBMFont* lbEarned_;
		CCSprite* lbLoss_;
		CCLabelBMFont* lbLoginIntoFacebook_;
		CCLabelBMFont* outPoints_;
		CCLabelBMFont* lbPoints_;
		CCLabelBMFont* outAccumulatedPoints_;
		CCLabelBMFont* lbAccumulatedPoints_;
		CCMenuItemSprite* btnMenu_;
		CCMenuItemSprite* btnReplay_;
		CCLabelBMFont* lbShareToFacebook_;
		CCSprite* lb5000XP_;
		CCMenuItemSprite* btnPostToFacebook_;
		
		CCLabelBMFont* lbUnlocked_;
		CCLabelBMFont* lbUnlockedUnitName_;
