...
public:
    ...
    virtual void handleTouchesBegin(int num, int ids[], float xs[], float ys[], int tapsCounts[]);
    virtual void handleTouchesMove(int num, int ids[], float xs[], float ys[], int tapsCounts[]);
    virtual void handleTouchesEnd(int num, int ids[], float xs[], float ys[], int tapsCounts[]);
    virtual void handleTouchesCancel(int num, int ids[], float xs[], float ys[], int tapsCounts[]);
...
private:
    void getSetOfTouchesEndOrCancel(CCSet& set, int num, int ids[], float xs[], float ys[], int tapsCounts[]);
