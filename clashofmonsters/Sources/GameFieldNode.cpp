...
void GameFieldNode::setContentSize(const cocos2d::CCSize size)
{
	...
	float cell_h = (getContentSize().height - (cocos2d_utils::isIPhone5() ? 88 : 0) - kGameFieldNodePaddingVertical * 2 - kGameFieldNodeIntervalVertical) /
		(kFieldHeight * 2);
