...
namespace monsters
{
	class GameLayer : public CCLayer, public IGameDelegate, public IGameHUDLayerDelegate, public INextRoundLayerDelegate,
	...
	public:
		bool init()
		{
			...
			bg_ = CCSprite::create(
				cocos2d_utils::textureName("Textures/Level_0-Background.jpg").c_str());
...
//			}
		...
		void updateBackground()
		{
			bg_->setTexture(CCSprite::create(
				cocos2d_utils::textureName(CCString::createWithFormat("Textures/Level_%d-Background.jpg", game_->stageBackgroundIndex())->
...
//						Session::sharedSession().user().avatarUrl() : onlineGame_->opponent().avatarUrl());
		...
		void showHitAtPoint(int hits, const CCPoint& pos, bool up)
		{
			...
			CCLabelBMFont* lb_cascade = CCLabelBMFont::create(createWithFormat("%d", hits).c_str(), cocos2d_utils::textureName("Fonts/badaboom.fnt").c_str());
			lb_cascade->setPosition(pos);
...
PlayScreen::PlayScreen() : alertOnlineBack_("Online Game",
