...
static monsters::AppDelegate s_sharedApplication;
...
//			performSelector:@selector(uniqueIdentifier)]];
//	#endif
//	[TestFlight takeOff:@"d8e4c53d-c98b-4726-8411-30b6f983df67"];
//
...
- (BOOL)application:(UIApplication *)application handleOpenURL:(NSURL *)url
{
	...
	if (ret)
		dynamic_cast<monsters::AppDelegate*>(CCApplication::sharedApplication())->showFacebookLoginLoadingIndicator();
